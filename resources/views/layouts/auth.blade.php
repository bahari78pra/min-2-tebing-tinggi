...
<head>
    ...
    <title>MIN 2 Tebing Tinggi || Administrator</title>
...
<body class="app">
    ...
    <div class="peers ai-s fxw-nw h-100vh">
        <div class="d-n@sm- peer peer-greed h-100 pos-r bgr-n bgpX-c bgpY-c bgsz-cv"
            style='background: url(/images/login-back3.jpg) no-repeat right top;background-size: cover;'>
        ...
        <div class="col-12 col-md-4 peer pX-40 pY-30 h-100 bgc-white scrollable pos-r"
            style='min-width: 320px;background-color: #999;'>
            <h1>MIN 2 Tebing Tinggi</h1>
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}"
                        name="email" value="{{ old('email') }}" placeholder="email@admin.com">
                    @if ($errors->has('email'))
