          ...
          <div class="peers ai-c fxw-nw">
            <div class="peer peer-greed"><a class="sidebar-link td-n" href="{{ route('admin./') }}">
                <div class="peers ai-c fxw-nw">
                  <div class="peer">
                    <div class="logo">
                      <img src="{{ asset('images/logo-islamiyah.png') }}" style='max-width:70px;margin-top:5px;padding:10px;'>
                    </div>
                  </div>
                  <div class="peer">
    ...
    <div class="page-container">
      <div class="header navbar">
        <div class="header-container">
            <div class="top-title"><i>Administrator</i> | Yayasan Pendidikan Islamiyah</div>
            <ul class="nav-right">
                <li class="dropdown">
                  <div style="position: absolute;top: 22px;right: 50px;text-align: right;width: 300px;font-weight: 400;"> </div>
...
{{--                       {{ auth()->user()->name}} --}}
                  ...
                  <ul class="dropdown-menu fsz-sm">
                    <li>
                      <a href="{{ route('admin.change-password') }}" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700">
                        <i class="ti-user mR-10"></i>
                        <span>Ganti Password</span>
                      </a>
                      <a href="{{ route('login') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700">
