                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <form action="#" method="GET" style='display:flex' class='mB-20'>
                            <input type="text" name="q" placeholder="Cari Slideshow" class='form-control'
                                value="{{ $keywords }}">
                    ...
                    <tbody>
                        ...
                        @foreach ($slideshows as $slideshow)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.slideshow.edit', $slideshow->id) }}" title="Edit"><button
                                            class="btn btn-warning"><span class="fa fa-pencil"></span></button></a>
                                    <form onsubmit="deleteThis(event)" action="{{ route('admin.slideshow.delete') }}"
