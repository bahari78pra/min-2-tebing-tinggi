...
@section("content")
<h4 class="c-grey-900 mT-10 mB-10">Edit Slideshow</h4>
<div>
    <form action="{{ route('admin.slideshow.update') }}" method="POST" class='row' enctype="multipart/form-data">
        {{ csrf_field() }} 
        {{ method_field('PUT') }}
            ...
            <div class="bgc-white bd bdrs-3 p-20 mB-20">
                ...
                <div class="form-row">
                    <div class="form-group col-sm-12">
                        ...
                        <input type="text" name="title" id="title" class='form-control' required value="{{ old('title', $slideshow->title) }}">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-sm-5">
                        ...
                        <input type="checkbox" name="status" id="status" @if(old('status')=="on" || $slideshow->status==1) checked="true" @endif>
                    </div>
                </div>
