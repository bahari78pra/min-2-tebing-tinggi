...
@section("content")
<h4 class="c-grey-900 mT-10 mB-10">Tambah Ekstrakurikkuler</h4>
<div>
    <form action="{{ route('admin.ekstrakurikuler.insert') }}" method="POST" class='row' enctype="multipart/form-data">
        {{ csrf_field() }} 
        {{ method_field('POST') }}
        ...
        <div class="col-md-12 col-lg-4">
            ...
            <div class="bgc-white bd bdrs-3 p-20 mB-20">
                <h6>Properti Ekstrakurikuler</h6>
                <div class="form-row">
                    <div class="form-group col-sm-12">
