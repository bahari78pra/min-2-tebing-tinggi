...
@section("content")
<h4 class="c-grey-900 mT-10 mB-10">Tambah Profil</h4>
<div>
    <form action="{{ route('admin.profile.insert') }}" method="POST" class='row' enctype="multipart/form-data">
        {{ csrf_field() }} 
        {{ method_field('POST') }}
            ...
            <div class="bgc-white bd bdrs-3 p-20 mB-20">
                ...
                <div class="form-row">
                    <div class="form-group col-sm-12">
                        ...
                        <textarea class="form-control" id="detail" name="detail" rows="40" required></textarea>
                    </div>
                </div>
            </div>
        </div>
