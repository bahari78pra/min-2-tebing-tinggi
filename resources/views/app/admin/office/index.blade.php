                ...
                <div class="bgc-white bd bdrs-3 p-20 mB-20">
                    ...
                    <div class="form-row">
                        <div class="form-group col-sm-12">
                            ...
                            <input type="text" name="name" id="name" class="form-control" required
                                @if (!empty($office->name)) value="{{ old('name', $office->name) }}" @endif>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-sm-12">
                            ...
                            <input type="text" name="address" id="address" class='form-control' required
                                @if (!empty($office->address)) value="{{ old('address', $office->address) }}" @endif>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-sm-12">
                            ...
                            <input type="email" name="email" id="email" class='form-control' required
                                @if (!empty($office->email)) value="{{ old('email', $office->email) }}" @endif>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-sm-12">
                            ...
                            <input type="text" name="phone" id="phone" class='form-control' required
                                @if (!empty($office->phone)) value="{{ old('phone', $office->phone) }}" @endif>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-sm-12">
                            ...
                            <input type="text" name="url_facebook" id="url_facebook" class='form-control' required
                                @if (!empty($office->url_facebook)) value="{{ old('url_facebook', $office->url_facebook) }}" @endif>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-sm-12">
                            ...
                            <input type="text" name="url_twitter" id="url_twitter" class='form-control' required
                                @if (!empty($office->url_twitter)) value="{{ old('url_twitter', $office->url_twitter) }}" @endif>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-sm-12">
                            ...
                            <input type="text" name="url_instagram" id="url_instagram" class='form-control' required
                                @if (!empty($office->url_instagram)) value="{{ old('url_instagram', $office->url_instagram) }}" @endif>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-sm-12">
                            ...
                            <input type="text" name="url_youtube" id="url_youtube" class='form-control' required
                                @if (!empty($office->url_youtube)) value="{{ old('url_youtube', $office->url_youtube) }}" @endif>
                        </div>
                    </div>
