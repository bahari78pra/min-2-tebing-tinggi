...
@section("content")
<h4 class="c-grey-900 mT-10 mB-10">Tambah Staff Pengajar</h4>
<div>
    <form action="{{ route('admin.staff.insert') }}" method="POST" class='row' enctype="multipart/form-data">
        {{ csrf_field() }} 
        {{ method_field('POST') }}
            ...
            <div class="bgc-white bd bdrs-3 p-20 mB-20">
                ...
                <div class="form-row">
                    <div class="form-group col-sm-12">
                        ...
                        <input type="text" name="tpt_lahir" id="tpt_lahir" class='form-control' required value="{{ old('tpt_lahir') }}">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-sm-12">
                        ...
                        <input type="text" name="agama" id="agama" class='form-control' required value="{{ old('agama') }}">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-sm-12">
                        ...
                        <input type="text" name="pendidikan_akhir" id="pendidikan_akhir" class='form-control' required value="{{ old('pendidikan_akhir') }}">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-sm-12">
                        ...
                        <i>Ukuran gambar yang direkomendasikan : W:350 x H:450</i>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-sm-12">
                        ...
                        <input type="text" name="no_urut_tampil" id="no_urut_tampil" class='form-control' required value="{{ old('no_urut_tampil') }}">
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-12 col-lg-4">
            <div class="bgc-white bd bdrs-3 p-20 mB-20">
                <h6>Aksi</h6>
                <p>Simpan data staff pengajar.</p>
