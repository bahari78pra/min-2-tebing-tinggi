...
@section('content')
    <h4 class="c-grey-900 mT-10 mB-10">Tambah Berita</h4>
    <div>
        <form action="{{ route('admin.news.insert') }}" method="POST" class='row' enctype="multipart/form-data">
            {{ csrf_field() }}
            {{ method_field('POST') }}
                    ...
                    <div class="form-row">
                        <div class="form-group col-sm-12">
                            ...
                            <select name="jenis" class="form-control" required>
                                ...
                                <option @if (old('jenis') == 'Berita') selected="selected" @endif>Berita</option>
                                <option @if (old('jenis') == 'Prestasi') selected="selected" @endif>Prestasi</option>
                            </select>
                        </div>
                    </div>
